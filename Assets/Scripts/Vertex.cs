...
public class Vertex 
{
    ...
    public Vertex(int _verticeIndex,Vector3 _initialVertexPosition,Vector3 _currentVertexPosition,Vector3 _currentVelocity)
    {
    ...
    public void ApplyPressueToVertex(Transform _transform,Vector3 _position,float _pressure)
    {
